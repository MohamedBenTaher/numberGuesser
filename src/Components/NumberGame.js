        ...
        <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center">
              <div className="bg-white rounded-lg shadow-lg px-6 py-4">
                  ...
                  <form onSubmit={handleGuessSubmit} className="flex flex-col items-center ">
                      <input type="number" value={guess} onChange={handleGuessChange} className="rounded-lg py-2 px-4 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent mr-4" />  
                      <div className='flex flex-row space-x-2'>
                        <button type="submit" className="mt-10 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                          {isLoading ? (
                      ...
                      <button type="reset" className="mt-10 bg-gray-400 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110" onClick={()=>setMessage('')}>
                          Reset
                      </button>
                      </div>
                  </form>
